...
<header>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white "  style="color: red;">
  <a class="navbar-brand" href="">Rural Education</a>
  ...
  <div class="collapse navbar-collapse " id="navbarNav">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link navbar-brand navbar-dark" href="#">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
